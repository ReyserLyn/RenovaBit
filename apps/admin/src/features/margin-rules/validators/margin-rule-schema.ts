...
// API caps name at 100 chars (apps/api/src/modules/margin-rules/model.ts).
export const MARGIN_RULE_NAME_MAX = 100;
export const MARGIN_PERCENT_MAX = 100;

// ── Zod Schemas ──────────────────────────────────────────

export const marginRuleFormSchema = z
	.object({
		name: z
			.string()
			.trim()
	...
	.refine((value) => value.maxPrice == null || value.maxPrice > value.minPrice, {
